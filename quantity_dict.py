...
dict_2D = {
    ...
    "edens_cm3":{"name":'edens', "vmin":1e17, "vmax":1e21, "cmap":'Blues', "cbar_label":'n$_e$ [cm$^{-3}$]'},
    "iondens_cm3":{"name":'iondens', "vmin":1e17, "vmax":1e21, "cmap":'Blues', "cbar_label":'n$_i$ [cm$^{-3}$]'},
...
dict_1D = {
    "density_cm3":{"min":1E14, "max":1E21, "ylabel":'n [cm$^{-3}$]'},
    "density":{"min":1e-2, "max":10, "ylabel":'n [n$_c$]'},
    "temp_eV":{"min":1, "max":5000, "ylabel":'T [eV]'},
