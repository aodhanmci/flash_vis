...
dict_2D = {
    ...
    "edens_cm3":{"name":'edens', "vmin":1e13, "vmax":1e21, "cmap":'Blues', "cbar_label":'n$_e$ [cm$^{-3}$]'},
    "iondens_cm3":{"name":'iondens', "vmin":1e13, "vmax":1e21, "cmap":'Blues', "cbar_label":'n$_i$ [cm$^{-3}$]'},
...
dict_1D = {
    "density_cm3":{"min":1E13, "max":1E21, "ylabel":'n [cm$^{-3}$]'},
